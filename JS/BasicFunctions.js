...
function resize() {
    ...
    toDoList.style.height = screenHeight*0.6 + "px";
    doingList.style.height = screenHeight*0.6 + "px";
    doneList.style.height = screenHeight*0.6 + "px";
}
